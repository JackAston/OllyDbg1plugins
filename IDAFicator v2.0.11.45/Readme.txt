...
I hope that all libyan citizen will be free soon. May GOD help you, Amen.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	1.5. 6 choosable layouts (a must have option).
...
The compiled binary code follows these rules :
	...
	3.6. Now you can toggle between 6 layouts according to your screen.(really
		helpful for people with wide screens).
		You can choose a layout by clicking the 7th custom button, then choose 
		a layout by left clicking it;
		If you want to switch dump with stack windows, you have to right click
		the same button.


4. History and news:
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
26/03/2011 # idaficator-2.0.11.45
	[!]: Goto offset and rva work as they should.
	[+]: idaficator's buttons readjusts their positions if status in buttons-bar
	[+]: You can now toggle between 6 layouts :) (see layouts entry above).

19/02/2011 # idaficator-2.0.2.39
	[!]: Fix bug in rote openning/re-openning/saving files.
	[!]: Fix bug CTRL+SHIFT+MClick asm window gives wrong results for some cmds.
	[!]: Fix bug no hook after close->reopen MDI principale window.
	
18/02/2011 # idaficator-2.0.1.48
...
17/02/2011 # idaficator-2.0.1.9 # first public release of version 2.0

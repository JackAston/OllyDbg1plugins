# $Id: server.py,v 1.13 2007/12/11 20:46:32 hochoa Exp $
...
def process_inithookentrytable( data ):
	...
	# now we allow the server to send us a new list
	# of hooks whenever it wants
...
try:
	...
	print "exception in reload: " + str(e)
""" % (pmodule)
				try:
					exec(cmd)
				except Exception, e:
					print "The uhooker handler has thrown an error!"
					print e
					hcall = HookCall()
...
print "Universal Hooker server started v1.3 (complaints to hernan@gmail.com)"
g_proxy = None 

/*
    Hehe Pedram :) I am a fan of your PDK's naming conventions ;)

    Anti Anti Hardware Breakpoint v0.1 - PDK Redefines
...
#define olly_delete_sorted_data_range	Deletesorteddatarange
#define olly_create_popup_menu		CreatePopupMenu
#define olly_append_menu		AppendMenu
#define olly_set_cpu			Setcpu
#define olly_paint_table		Painttable
#define olly_get_cpu_thread_id		Getcputhreadid
#define olly_find_thread		Findthread
#define olly_write_memory		Writememory

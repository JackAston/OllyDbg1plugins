...
#define _dllexport		extc _export
...
extc int     cdecl _Decodeaddress(ulong addr,ulong base,int addrmode,
								  char *symb,int nsymb,char *comment);
extc int     cdecl _Decoderelativeoffset(ulong addr,int addrmode,
										 char *symb,int nsymb);
extc int     cdecl _Decodecharacter(char *s,uint c);
extc int     cdecl _Printfloat4(char *s,float f);
extc int     cdecl _Printfloat8(char *s,double d);
extc int     cdecl _Printfloat10(char *s,long double ext);
extc int     cdecl _Print3dnow(char *s,uchar *f);
extc int     cdecl _Printsse(char *s,char *f);
extc ulong   cdecl _Followcall(ulong addr);
extc int     cdecl _IstextA(char c);
extc int     cdecl _IstextW(wchar_t w);
...
extc int     cdecl _Getmmx(char *title,uchar *data,int mode);
extc int     cdecl _Getmmxxy(char *title,char *data,int mode,int x,int y);
...
extc int     cdecl _Gettableselectionxy(t_table *pt,int column,int *px,int *py);
...
extc int     cdecl _Quickinsertname(ulong addr,int type,char *name);
...
extc int     cdecl _Decodename(ulong addr,int type,char *name);
extc ulong   cdecl _Findnextname(char *name);
extc int     cdecl _Findlabel(ulong addr,char *name);
extc void    cdecl _Deletenamerange(ulong addr0,ulong addr1,int type);
extc int     cdecl _Findlabelbyname(char *name,ulong *addr,
									ulong addr0,ulong addr1);
extc ulong   cdecl _Findimportbyname(char *name,ulong addr0,ulong addr1);
extc int     cdecl _Demanglename(char *name,int type,char *undecorated);
...
extc ulong   cdecl _Disassembleback(uchar *block,ulong base,ulong size,
									ulong ip,int n,int usedec);
extc ulong   cdecl _Disassembleforward(uchar *block,ulong base,ulong size,
									   ulong ip,int n,int usedec);
extc int     cdecl _Issuspicious(char *cmd,ulong size,ulong ip,
								 ulong threadid,t_reg *preg,char *s);
extc int     cdecl _Isfilling(ulong offset,char *data,ulong size,ulong align);
...
extc int     cdecl _Checkcondition(int code,ulong flags);
...
extc int     cdecl _Expression(t_result *result,char *expression,int a,int b,
...
extc int     cdecl _Decodethreadname(char *s,ulong threadid,int mode);
extc ulong   cdecl _Getcputhreadid(void);
extc ulong   cdecl _Runsinglethread(ulong threadid);
...
extc int     cdecl _Listmemory(void);
extc t_memory* cdecl _Findmemory(ulong addr);
extc int     cdecl _Guardmemory(ulong base,ulong size,int guard);
...
extc int     cdecl _Registerotclass(char *classname,
									char *iconname,WNDPROC classproc);
extc HWND    cdecl _Newtablewindow(t_table *pt,int nlines,int maxcolumns,
								   char *winclass,char *wintitle);
extc HWND    cdecl _Quicktablewindow(t_table *pt,int nlines,int maxcolumns,
									 char *winclass,char *wintitle);
extc HWND    cdecl _Createdumpwindow(char *name,ulong base,ulong size,
...
extc int     cdecl _Broadcast(UINT msg,WPARAM wp,LPARAM lp);

////////////////////////////////////////////////////////////////////////////////
////////////////////////// DATA CONVERSION FUNCTIONS ///////////////////////////

extc ulong   cdecl _Compress(uchar *bufin,ulong nbufin,
							 uchar *bufout,ulong nbufout);
extc ulong   cdecl _Getoriginaldatasize(char *bufin,ulong nbufin);
extc ulong   cdecl _Decompress(uchar *bufin,ulong nbufin,
							   uchar *bufout,ulong nbufout);
extc ulong   cdecl _Calculatecrc(uchar *copy,ulong base,ulong size,
...
extc int     cdecl _Findreferences(ulong base,ulong size,ulong addr0,ulong addr1,
								   ulong origin,int recurseonjump,char *title);
extc int     cdecl _Findstrings(ulong base,ulong size,ulong origin,char *title);
extc int     cdecl _Findalldllcalls(t_dump *pd,ulong origin,char *title);
extc int     cdecl _Findallcommands(t_dump *pd,t_asmmodel *model,
									ulong origin,char *title);
extc int     cdecl _Findallsequences(t_dump *pd,t_extmodel model[NSEQ][NMODELS],
									 ulong origin,char *title);
extc ulong   cdecl _Walkreference(int dir);
extc ulong   cdecl _Walkreferenceex(int dir,ulong *size);
...
extc int     cdecl _Setbreakpoint(ulong addr,ulong type,uchar cmd);
extc int     cdecl _Setbreakpointext(ulong addr,ulong type,char cmd,
									 ulong passcount);
extc int     cdecl _Manualbreakpoint(ulong addr,
									 int key,int shiftkey,ulong nametype,int font);
extc void    cdecl _Deletebreakpoints(ulong addr0,ulong addr1,int silent);
extc ulong   cdecl _Getbreakpointtype(ulong addr);
extc ulong   cdecl _Getbreakpointtypecount(ulong addr,ulong *passcount);
extc ulong   cdecl _Getnextbreakpoint(ulong addr,ulong *type,int *cmd);
extc void    cdecl _Tempbreakpoint(ulong addr,int mode);
extc int     cdecl _Hardbreakpoints(int closeondelete);
...
extc int     cdecl _Setmembreakpoint(int type,ulong addr,ulong size);
extc uchar*  cdecl _Findhittrace(ulong addr,uchar **ptracecopy,ulong *psize);
extc int     cdecl _Modifyhittrace(ulong addr0,ulong addr1,int mode);
extc ulong   cdecl _Isretaddr(ulong retaddr,ulong *procaddr);
...
extc int     cdecl _Findnextruntraceip(ulong ip,int startback);
extc int     cdecl _Getruntraceregisters(int nback,t_reg *preg,
										 t_reg *pold,char *cmd,char *comment);
extc int     cdecl _Getruntraceprofile(ulong addr,ulong size,ulong *profile);
extc void    cdecl _Scrollruntracewindow(int back);
extc HWND    cdecl _Createprofilewindow(ulong base,ulong size);
...
extc int     cdecl _Injectcode(ulong threadid,t_inject *inject,char *data,
...
extc void    cdecl _Setcpu(ulong threadid,ulong asmaddr,
...
extc ulong   cdecl _Findprocbegin(ulong addr);
extc ulong   cdecl _Findprocend(ulong addr);
extc ulong   cdecl _Findprevproc(ulong addr);
extc ulong   cdecl _Findnextproc(ulong addr);
extc int     cdecl _Getproclimits(ulong addr,ulong *start,ulong *end);
...
extc int     cdecl _Suspendprocess(int processevents);
...
extc uchar*  cdecl _Findknownfunction(ulong addr,int direct,
									  int level,char *fname);
extc int     cdecl _Decodeknownargument(ulong addr,uchar *arg,ulong value,
										int valid,char *s,char *mask,uchar *pset[]);
extc char    cdecl *_Findunknownfunction(ulong ip,char *code,char *dec,
										 ulong size,char *fname);
extc int     cdecl _Decodeascii(ulong value,char *s,int len,int mode);
extc int     cdecl _Decodeunicode(ulong value,char *s,int len);
...
extc HWND    cdecl _Showsourcefromaddress(ulong addr,int show);
extc int     cdecl _Getresourcestring(t_module *pm,ulong id,char *s);
extc t_sourceline* cdecl _Getlinefromaddress(ulong addr);
extc ulong   cdecl _Getaddressfromline(ulong addr0,ulong addr1,
									   char *path,ulong line);
extc int     cdecl _Getsourcefilelimits(ulong nameaddr,
										ulong *addr0,ulong *addr1);
extc int     cdecl _Decodefullvarname(t_module *pmod,t_symvar *psym,
									  int offset,char *name);
extc int     cdecl _Getbprelname(t_module *pmod,ulong addr,long offset,
								 char *s,int nsymb);

////////////////////////////////////////////////////////////////////////////////
//////////////////////////////// WATCH SUPPORT /////////////////////////////////

extc HWND    cdecl _Createwatchwindow(void);
extc int     cdecl _Deletewatch(int indexone);
extc int     cdecl _Insertwatch(int indexone,char *text);
extc int     cdecl _Getwatch(int indexone,char *text);
...
extc HWND    cdecl _Createwinwindow(void);
...
extc HWND    cdecl _Createpatchwindow(void);
...
extc void    cdecl _Unregisterpluginclass(char *classname);
...
extc int     cdecl _Pluginreadstringfromini(HINSTANCE dllinst,char *key,
											char *s,char *def);
extc int     cdecl _Pluginsaverecord(ulong tag,ulong size,void *data);
...
extc int  _export cdecl _ODBG_Plugininit(int ollydbgversion,HWND hw,
										 ulong *features);
extc void _export cdecl _ODBG_Pluginmainloop(DEBUG_EVENT *debugevent);
extc void _export cdecl _ODBG_Pluginsaveudd(t_module *pmod,int ismainmodule);
extc int  _export cdecl _ODBG_Pluginuddrecord(t_module *pmod,int ismainmodule,
...
extc int  _export cdecl _ODBG_Pluginshortcut(
											 int origin,int ctrl,int alt,int shift,int key,
											 void *item);
extc void _export cdecl _ODBG_Pluginreset(void);
extc int  _export cdecl _ODBG_Pluginclose(void);
extc void _export cdecl _ODBG_Plugindestroy(void);
extc int  _export cdecl _ODBG_Paused(int reason,t_reg *reg);
extc int  _export cdecl _ODBG_Pausedex(int reasonex,int dummy,t_reg *reg,
									   DEBUG_EVENT *debugevent);
extc int  _export cdecl _ODBG_Plugincmd(int reason,t_reg *reg,char *cmd);
